...
export default function MyInfo() {
    ...
    useEffect(async () => {
        const myInfo = await get(`/info`);
        if (myInfo.data.success === true) {
            setAllSolvedList(myInfo.data.mySolveList);
            setData(myInfo.data.mySolveList.slice(0, 10));
    ...
    const PlusIndex = () => {
        setData(allSolvedList.slice(10 * (startIndex + 1), 10 * (endIndex + 1)));
            ...
            <div className="MyInfoWrap">
                ...
                <div className="MyInfoSolveListWrap">
                    ...
                    <div className="MyInfoButtonWrap">
                        ...
                        <button
                            onClick={PlusIndex}
                            disabled={endIndex * 10
                                 >= allSolvedList.length ? true : false}
                        >
                            &gt;
                        </button>
                    </div>
